...
import Container, { TicketDeleteButton } from 'components/tickets/TicketDeleteButton'
...
describe('TicketDeleteButton Component', () => {
  ...
  it('calls the delete ticket action', () => {
    ...
    const wrapper = mount(<TicketDeleteButton ticket={ticket} deleteTicket={callback} />)
